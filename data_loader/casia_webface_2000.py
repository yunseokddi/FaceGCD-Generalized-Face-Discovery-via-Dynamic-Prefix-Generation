...
def get_casiaface2000_datasets(train_transform, test_transform, train_classes=range(1000), prop_train_labels=0.5,
                               seed=0, split_train_val=False, args=None, root='/home/compu/Datasets/casia_face/train.rec'):
    np.random.seed(seed)

    dataset = FaceDataset2000(transform=None,
                                path_imgrec=os.path.join(args.data_path, 'train.rec'), num_labels=2000, min_samples_per_label=50)
...
if __name__ == '__main__':
    ...
    x = get_casiaface2000_datasets(None, None, prop_train_labels=0.5)
