...
from data_loader.data_utils import subsample_instances

car_root = "/home/compu/Datasets/SSB_benchmark/scars/cars_{}/"
meta_default_path = "/home/compu/Datasets/SSB_benchmark/scars/cars_{}.mat"


class CarsDataset(Dataset):

    def __init__(self, train=True, limit=0, data_dir=car_root, transform=None, metas=meta_default_path, args=None, target_transform=None):
...
def get_scars_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
                       split_train_val=False, seed=0, args=None, target_transform=None):
    np.random.seed(seed)
    ...
    test_dataset = CarsDataset(data_dir=car_root, transform=test_transform, metas=meta_default_path, train=False, target_transform=target_transform)
