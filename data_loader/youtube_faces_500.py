...
class YoutubeFaces500(torchvision.datasets.ImageFolder):
...
def get_youtubefaces500_datasets(train_transform, test_transform, train_classes=range(250), prop_train_labels=0.5,
                            seed=0, split_train_val=False, args=None):
    np.random.seed(seed)

    train_dataset = YoutubeFaces500(transform=train_transform,
    ...
    test_dataset = YoutubeFaces500(transform=test_transform,
...
if __name__ == '__main__':
    ...
    x = get_youtubefaces500_datasets(None, None, prop_train_labels=0.5)
