...
def get_cub_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    whole_training_set = CustomCub2011(root=args.data_path, transform=train_transform, train=True)
    ...
    test_dataset = CustomCub2011(root=args.data_path, transform=test_transform, train=False)
