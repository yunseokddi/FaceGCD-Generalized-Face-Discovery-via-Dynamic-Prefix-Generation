...
class YoutubeFaces1000(torchvision.datasets.ImageFolder):
...
def subsample_classes(dataset, include_classes=range(500)):
...
def get_youtubefaces1000_datasets(train_transform, test_transform, train_classes=range(500), prop_train_labels=0.5,
                            seed=0, split_train_val=False, args=None):
    np.random.seed(seed)

    train_dataset = YoutubeFaces1000(transform=train_transform,
    ...
    test_dataset = YoutubeFaces1000(transform=test_transform,
...
if __name__ == '__main__':
    ...
    x = get_youtubefaces1000_datasets(None, None, prop_train_labels=0.5)
