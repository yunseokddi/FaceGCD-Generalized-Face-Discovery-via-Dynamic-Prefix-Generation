...
def get_args_parser(parser):
    ...
    group.add_argument('--transform', type=str, default='imagenet')
    group.add_argument('--not-contrastive', default=False, action='store_true')
    group.add_argument('--n-views', default=2, type=int)
    group.add_argument('--prop-train-labels', type=float, default=0.5)
    group.add_argument('--only-label', default=False, action='store_true')
    group.add_argument('--only-unlabel', default=False, action='store_true')
    group.add_argument('--contrast_unlabel_only', type=str2bool, default=False)
    group.add_argument('--osr_split_dir', default='SSB_benchmark/ssb_splits', type=str,
                        help='osr split dir')
    group.add_argument('--use_ssb_splits', default=False, action='store_true')
    ...
    group.add_argument('--return-embed', action='store_true', default=False,
                       help='return immediate embeddings')
    group.add_argument('--freeze',
                        default=['blocks', 'patch_embed', 'cls_token', 'norm', 'pos_embed', 'head'],
                        nargs='*',
                        type=list, help='freeze part in backbone model')

    group.add_argument('--dino_fe', action='store_true', default=False,
                       help='use dino feature extractor')
    ...
    group.add_argument('-val-interval', type=int, default=10, metavar='N',
                       help='how many batches to wait before logging training status')
    ...
    group.add_argument('--eval_funcs', nargs='+', help='Which eval functions to use', default=['v1', 'v2'])
    ...
    group.add_argument('--experiment_idx', default='experiment_1', type=str,
                        help='name of train experiment index, name of sub-folder for output')
    ...
    # Semi-supervised K-means parameters
    ...
    group.add_argument('--ssk_mode', default='train',
                       type=str, help='SSK mode')
    group.add_argument('--ssk_centres', default='ss_kmeans_cluster_centres.pt',
                       type=str, help='SSK centers pt file name')

    # landmark_path
    group.add_argument('--landmark_cnn', action='store_true', default=False,
                       help='use landmark cnn')
    group.add_argument('--landmark_path',
